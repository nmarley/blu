...
import { FileEntry, GlobalStatus, KeyStatus } from '@/types';
                    ...
                    <main className="flex-1 p-6">
                        ...
                        <div className="mt-4 p-4 rounded-lg border bg-card">
                            <p className="text-sm text-muted-foreground">
                                Status: {mockGlobalStatus.totalFiles} files |{' '}
                                {mockGlobalStatus.encryptedCount} encrypted |{' '}
                                {mockGlobalStatus.uploadedCount} uploaded to S3
                                | {mockGlobalStatus.pendingCount} pending |{' '}
                                {mockGlobalStatus.unencryptedCount} unencrypted
                            </p>
                        </div>
                    </main>
                </div>
